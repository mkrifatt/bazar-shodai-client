        ...
        <div className="container">
            ...
            <div className="form">
                ...
                <form>
                    ...
                    {
                        newUser && <input type="submit" onClick={handleSignUp} className="form-control btn btn-success" value="Create New Account" />
                    }

                    {
                        !newUser && <input type="submit" onClick={handleLogin} className="form-control btn btn-success" value="Log In" />
                    }
